    ...
    <div className="container mx-auto">
      ...
      <div className="flex justify-between gap-1 pb-3">
        ...
        <div className="">
          ...
          <Link href={"/admin/Ordering/Purchase/delievery/Externalvendoe"}>
        ...
        <tbody>
          {slicedData.map((item) => (
            <tr key={item.id}>
              ...
              <td className="px-2 py-2">10-5-2024</td>
              ...
              <td className="px-2 py-2">
                <div>
                  <div className="flex mb-2">
                    <Link href="/admin/Ordering/Purchase/delievery/viewdelievery">
                      <Button
                        color="warning"
                    ...
                    <Link href="/admin/Ordering/Purchase/delievery/Returnstocks">
                      <Button className="p-0 bg-gray-500 hover:bg-[#1f5081] text-white text-sm px-1">
                        <Undo2 size={20}></Undo2>
                        Return
                      </Button>
                    </Link>
                  ...
                  <div>
                    <Link href="/admin/Ordering/Purchase/delievery/AcceptStocks">
                      <Button className="p-0 bg-red-600 hover:bg-red-500 mr-2 text-white text-sm px-1">
                        <Check size={20}></Check> Accept
                      </Button>
                    </Link>

                    <Link href="/admin/Ordering/Purchase/delievery/Wastagestack">
                      <Button className="p-0 bg-[#DBF3A6]  mr-2 hover:bg-[#edfdc9] text-blue-900 px-1 fill-white">
                        <RectangleHorizontal size={20}></RectangleHorizontal>
                        wastage
                      </Button>
                    </Link>
                  </div>
