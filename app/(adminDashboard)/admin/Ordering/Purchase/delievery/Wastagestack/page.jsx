  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 p-3">
        ...
        <div>
          <label className="font-bold inline-block w-32 ">Wastage Type</label>
          <select className="border border-black dark:border-white p-2 bg-transparent w-24 ">
            <option>1</option>
          </select>
        </div>
