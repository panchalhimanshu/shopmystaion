  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex justify-between gap-1 pb-3">
        <div className="text-2xl text-orange-400">PO List</div>
        <div className="">
          {/* <StaffImportModal /> */}
            ...
            <tr key={item.id}>
              ...
              <td className="px-2 py-2">
                <div className="flex mb-2">
                  <Link href="/station/Purchase/po/viewpo">
                    <Button
                      color="warning"
                  ...
                  <Button className="p-0 bg-red-600 hover:bg-red-500 mr-2 text-white text-sm px-4">
                    <Trash size={20}></Trash> Cancel
                  </Button>
                  <Button className="p-0 bg-[#DBF3A6] hover:bg-[#edfdc9] text-blue-900 px-2">
                    <Mail size={20}></Mail>
                  </Button>
                </div>
              </td>
