...
import { DownloadIcon, Eye, Search, SearchIcon } from 'lucide-react';
...
const document = () => {
  ...
  const downloadDocument = async (docurl, filename, format) => {
    try {
      const response = await axios.get(`http://192.168.1.176:126/${docurl}`, {
        ...
        <thead>
          <tr>
            ...
            <th className="  px-4 py-2 cursor-pointer" onClick={() => handleSort('email')}>
              UPLOADEDDATE {sortConfig.key === 'email' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className=" px-4 py-2 cursor-pointer" onClick={() => handleSort('phone')}>
              FORMATE {sortConfig.key === 'phone' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className=" px-4 py-2 cursor-pointer" onClick={() => handleSort('phone')}>
            ...
            <tr key={item.id}>
              ...
              <td>
                <div className='text-center'>
                  ...
                  // onClick={() => router.push("/admin/Warehouse/staff/staffDetail")}
                  >
                    <Eye size={15}></Eye>
                  </Button>
                  <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-gray-700  dark:text-white"
                  ...
                  >
                    <DownloadIcon size={15}></DownloadIcon>
                  </Button>
                </div>
              </td>
            </tr>
