        ...
        <thead>
          <tr>
            ...
            <th className="  px-4 py-2 cursor-pointer" onClick={() => handleSort('email')}>
              ORDERS {sortConfig.key === 'email' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className=" px-4 py-2 cursor-pointer" onClick={() => handleSort('phone')}>
              EMAILID {sortConfig.key === 'phone' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className=" px-4 py-2 cursor-pointer" onClick={() => handleSort('phone')}>
              SPECIAL CUSTOMER {sortConfig.key === 'phone' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className=" px-4 py-2 cursor-pointer" onClick={() => handleSort('phone')}>
              ...
              <td>
                <div className='text-center'>
                  <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-gray-700  dark:text-white"
                    onClick={() => router.push(`/admin/station/customer/customerDetail/${item.uid}`)}
                  >
                    <Eye size={15}></Eye>
                  </Button>
                </div>
