        ...
        <thead>
          <tr>
            ...
            <th className="px-2 py-2 cursor-pointer" onClick={() => handleSort('id')}>
              LOG LEVEL {sortConfig.key === 'id' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className="px-2 py-2 cursor-pointer" onClick={() => handleSort('title')}>
              SHORTMESSAGE {sortConfig.key === 'title' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className="px-2 py-2 cursor-pointer" onClick={() => handleSort('completed')}>
              CREATED ON {sortConfig.key === 'completed' ? (sortConfig.direction === 'asc' ? '▲' : '▼') : ''}
            </th>
            <th className="px-2 py-2 cursor-pointer" onClick={() => handleSort('completed')}>
            ...
            <tr key={item.id}>
              ...
              <td className="px-4 py-2">
                <div className="text-center">
                  <Button className="p-0 mr-2 bg-transparent text-gray-600  dark:text-white hover:bg-transparent "onClick={()=>router.push("/admin/Audit_logs/viewauditlogs")}>
                    <Eye size={15}></Eye>
                  </Button>
                </div>
              </td>
