...
const offerdiscount = () => {
  ...
  <div key={field} className="flex items-center mb-2">
   ...
   <Link href={"/station/portals/offer&Discount/addofferdiscount"}>   <Button color="warning" className="shadow-md"><Plus size={20} className='pr-1' />Add</Button> </Link>
          ...
          {slicedData.map((item) => (
            <tr key={item.id}>
              ...
              <td className="px-2 py-2">
                <div>
                <Link href={"/station/portals/offer&Discount/viewofferdiscount"}>  <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
                    <Eye size={20}></Eye>
                  </Button></Link>
                  <Link href={"/station/portals/offer&Discount/editofferdiscount"}>  <Button className="p-0 mr-2 bg-transparent hover:bg-transparent text-black  dark:text-white">
