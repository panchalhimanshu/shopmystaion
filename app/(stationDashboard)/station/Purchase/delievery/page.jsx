              ...
              <td className="px-2 py-2">
                <div>
                  <div className="flex mb-2">
                    <Link href="/station/Purchase/delievery/viewdelievery">
                      <Button
                        color="warning"
                    ...
                    <Link href="/station/Purchase/delievery/Returnstocks">
                  ...
                  <div>
                    <Link href="/station/Purchase/delievery/AcceptStocks">
                      <Button className="p-0 bg-green-600 hover:bg-green-500 mr-2 text-white text-sm px-1">
                        <Check size={20}></Check> Accept
                      </Button>
                    </Link>

                    <Link href="/station/Purchase/delievery/Wastagestack">
                      <Button className="p-0 bg-red-600 hover:bg-red-500 mr-2 text-white px-1 fill-white">
                        <RectangleHorizontal
                          size={15}
