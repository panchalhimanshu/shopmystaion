...
const topWastage = () => {
    ...
    const getOrderForReport = async () => {
        const response = await CallFor(`v2/Report/TopWastage?OrgId=${userData?.orgid}&UaId=${userData?.uaid}&From=${searchQuery?.FromDate}&To=${searchQuery?.Todate}&NoRecords=1`, 'GET', null, 'Auth');
