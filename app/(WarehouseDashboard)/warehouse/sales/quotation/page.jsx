              ...
              <td className="px-2 py-2">
                <div>
                  <div className="flex mb-2">
                    <Link href="/warehouse/sales/quotation/viewquotation">
                      <Button
                        color="warning"
                    ...
                    <Link href="/warehouse/sales/quotation/createquotation">
                  ...
                  <div>
                    ...
                    <Button className="p-0 bg-red-600 hover:bg-red-500 text-white text-sm px-4">
                      <Trash size={20}></Trash> Reject
                    </Button>
                  </div>
                </div>
              </td>
