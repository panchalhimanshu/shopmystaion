  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 p-3">
        <div className="pb-3">
          <label className="font-bold inline-block w-32 ">So. Date</label>
        ...
        <div className="py-8 mt-10 mb-7  border-t-2 border-black dark:border-white border-dashed max-w-4xl">
          <table className="border-b border-black dark:border-white">
            <thead>
              ...
              <th className="py-3 px-6 text-center"> Quantity Requested</th>
              <th className="py-3 px-6 text-center">Quantity sent</th>
      ...
      <div className="flex justify-end">
        <div>
          <Link href="/warehouse/sales/so/addso">
            <Button className="text-white bg-[#11375C]">Add Delivery</Button>
          </Link>
        </div>
      </div>
    </div>
