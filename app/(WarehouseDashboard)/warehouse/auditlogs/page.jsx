...
import { Download, DownloadIcon, Eye, Import, Plus, Search, SearchIcon, Upload } from 'lucide-react';
      ...
      <div className="mb-4 grid grid-cols-1 lg:grid-cols-2 gap-x-10">
        ...
        {Object.keys(tempSearchFields).map((field) => (
          <div key={field} className="flex items-center mb-2">
            ...
            {field === "Log Leve" ? ( // Check if field is "Log Leve"
              <select
              ...
              <input
                type={
                  field === "Created To" || field === "CreatedFrom"
                    ? "date"
                    : "text"
          ...
          {slicedData.map((item) => (
            <tr key={item.id}>
              ...
              <td className="px-2 py-2 text-center">
                <Link href={"/warehouse/auditlogs/viewauditlogs"}>
                  <Eye size={15}></Eye>
                </Link>
              </td>
            </tr>
