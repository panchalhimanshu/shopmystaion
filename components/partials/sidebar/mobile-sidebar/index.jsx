...
const MobileSidebar = ({ collapsed, className }) => {
  ...
  return (
    <>
      <div
        className={cn(
          "fixed top-0  bg-[#11375C] text-white  h-full w-[248px] z-[9999] ",
          className,
          {
      ...
      >
        {sidebarBg !== "none" && (
          <div
            className="bg-[#11375C] text-white absolute left-0 top-0   z-[-1] w-full h-full bg-cover bg-center opacity-[0.07]"
      ...
      {mobileMenu && (
        <div
          ...
          className="overlay bg-black/60 backdrop-filter  opacity-100 fixed inset-0 z-[999]"
        ></div>
      )}
    </>
  );
