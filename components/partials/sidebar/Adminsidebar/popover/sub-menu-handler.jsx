      ...
      {collapsed ? (
        <HoverCard.Root>
          ...
          <HoverCard.Portal>
            ...
            >
              <ScrollArea
                className={ cn("p-4 rounded-lg bg-[#11375C]", {
                  "h-[250px]":
                    item.child.length > 5 ||
                    item.child.some(
                      (childItem) =>
        ...
        <div
          ...
          className={cn(
            "flex   font-medium text-sm capitalize px-[10px] py-3 rounded cursor-pointer transition-all duration-100 hover:bg-primary hover:text-primary-foreground group",
            {
        ...
        >
          <div className="flex-1  gap-3 flex items-start">
            <span className="inline-flex items-center  text-lg ">
              <item.icon className="w-6 h-6 fill-white dark:fill-white active:  " />
            </span>
          ...
          <div className="flex-0  ">
            <div
              className={cn(
                "  rounded-full flex justify-center items-center transition-all duration-300 group-hover:text-primary-foreground ",
                {
