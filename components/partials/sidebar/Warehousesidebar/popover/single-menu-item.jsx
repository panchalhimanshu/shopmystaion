        ...
        {collapsed ? (
            ...
            <Tooltip.Provider>
              <Tooltip.Root>
                <Tooltip.Trigger asChild>
                  ...
                  >
                    <item.icon className="w-6 h-6 fill-white dark:fill-white  " />
                  </span>
                </Tooltip.Trigger>
                <Tooltip.Portal>
                  <Tooltip.Content
                    side="right"
                    className="bg-primary  data-[state=delayed-open]:data-[side=top]:animate-slideDownAndFade data-[state=delayed-open]:data-[side=right]:animate-slideLeftAndFade data-[state=delayed-open]:data-[side=left]:animate-slideRightAndFade data-[state=delayed-open]:data-[side=bottom]:animate-slideUpAndFade text-violet11 select-none rounded-[4px]  px-[15px] py-[10px] text-[15px] leading-none  shadow-sm will-change-[transform,opacity ]"
                    sideOffset={5}
                  >
                    {title}
          ...
          >
            <span className="flex-grow-0">
              <item.icon className="w-5 h-5 fill-white dark:fill-white" />
            </span>
            <div className="text-box flex-grow text-white ">{title}</div>
