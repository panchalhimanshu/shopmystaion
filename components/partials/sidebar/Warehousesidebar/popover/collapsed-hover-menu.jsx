...
const CollapsedHoverMenu = ({ item, index, menuTitle }) => {
  ...
  return (
    <>
      {item?.child ? (
        <ul className="space-y-2 bg-[#11375C] text-white relative before:absolute before:left-4 before:top-0  before:h-[calc(100%-5px)]  before:w-[2px] before:bg-primary/20 before:rounded">
